...
{
    public abstract class SerilogIntegrationTestBaseProxy
    {
        ...
        protected SerilogIntegrationTestBaseProxy(Uri baseUrl)
        {
            BaseUrl = baseUrl;
...
namespace Birch.Swagger.ProxyGenerator.IntegrationTest.PetStore {
    ...
    /// Web Proxy for pet
    /// </summary>
    public class petWebProxy : SerilogIntegrationTestBaseProxy, IpetWebProxy
    {
    ...
    /// Web Proxy for store
    /// </summary>
    public class storeWebProxy : SerilogIntegrationTestBaseProxy, IstoreWebProxy
    {
    ...
    /// Web Proxy for user
    /// </summary>
    public class userWebProxy : SerilogIntegrationTestBaseProxy, IuserWebProxy
    {
